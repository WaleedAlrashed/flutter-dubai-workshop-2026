...
class RegisterScreen extends ConsumerStatefulWidget {
  ...
  final bool isDark;
  const RegisterScreen({super.key, required this.onToggleTheme, required this.isDark});
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Phone', prefixIcon: Icon(Icons.phone), hintText: '+971 XX XXX XXXX', border: OutlineInputBorder()),
                    keyboardType: TextInputType.phone,
                  ),
                  const SizedBox(height: 16),
                  DropdownButtonFormField<String>(
                    decoration: const InputDecoration(labelText: 'Nationality', prefixIcon: Icon(Icons.flag), border: OutlineInputBorder()),
